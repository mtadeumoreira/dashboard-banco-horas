...
conteudo.append(tabela_func)
    ...
    conteudo.append(Paragraph(f"<b>Horas:</b> {round(total_geral_horas,2)} h", styles['Normal']))
    conteudo.append(Paragraph(f"<b>Valor:</b> R$ {total_geral_valor:,.2f}", styles['Normal']))
